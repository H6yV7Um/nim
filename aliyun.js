...
! function a(b, c, d) {
	...
	7: [function(a, b, c) {
		var d = a("../ui/component"),
			...
			i = d.extend({
				...
				createEl: function() {
					...
					return a.innerHTML = "<div><p class='tip-text'></p></div><div class='operators'><a class='prism-button prism-button-ok' type='button'>" + g.get("OK_Text") + "</a><a class='prism-button prism-button-cancel'  target='_blank'>" + g.get("Cancel_Text") + "</a></div>", a
				},
				bindEvent: function() {
					var a = this;
					a._player.on(h.Private.AutoStreamShow, function(b) {
					...
					f.on(b, "click", function() {
						a._player._changeStream && a._switchUrl && a._player._changeStream(a._switchUrl.index), e.css(a.el(), "display", "none")
					});
					var c = document.querySelector("#" + a.getId() + " .prism-button-cancel");
					f.on(c, "click", function() {
						e.css(a.el(), "display", "none")
					})
				}
			});
		...
		"../lib/ua": 31,
		"../lib/util": 33,
		"../player/base/event/eventtype": 38,
		"../ui/component": 80
	}],
	8: [function(a, b, c) {
		var d = a("../ui/component"),
			...
			k = d.extend({
				...
				createEl: function() {
					...
					return a.innerHTML = '<div class="prism-enable-liveshift"><div class="prism-progress-loaded"></div><div class="prism-progress-played"></div><div class="prism-progress-cursor"></div><p class="prism-progress-time"></p><div class="prism-liveshift-seperator"></div></div><div class="prism-disable-liveshift"></div>', a
				},
				bindEvent: function() {
					var a = this;
					this.loadedNode = document.querySelector("#" + this.id() + " .prism-progress-loaded"), this.playedNode = document.querySelector("#" + this.id() + " .prism-progress-played"), this.cursorNode = document.querySelector("#" + this.id() + " .prism-progress-cursor"), this.timeNode = document.querySelector("#" + this.id() + " .prism-progress-time"), this.controlNode = document.querySelector("#" + this._player._options.id + " .prism-controlbar"), this.seperatorNode = document.querySelector("#" + this.id() + " .prism-liveshift-seperator"), this.progressNode = document.querySelector("#" + this.id() + " .prism-enable-liveshift"), f.on(this.cursorNode, "mousedown", function(b) {
						...
						a._liveshiftService.start(6e4, function(b) {
							var c = {
								mediaId: a._player._options.vid ? a._player._options.vid : "",
								error_code: b.Code,
								error_msg: b.Message
							};
							a._player.logError(c), a._player.trigger(j.Player.Error, c)
						})
				...
				_updateSeperator: function() {
					var a = this._liveshiftService.availableLiveShiftTime / this._liveshiftService.liveTimeRange.totalTime;
					a = a > 1 ? 1 : a, e.css(this.progressNode, "width", 100 * a + "%")
				},
				_progressMove: function(a) {},
				...
				_canSeekable: function(a) {
					var b = !0;
					return "function" == typeof this._player.canSeekable && (b = this._player.canSeekable(a)), b
				},
				_onMouseOver: function(a) {
					e.css(this.cursorNode, "display", "block"), e.css(this.timeNode, "display", "block"), this._progressMove(a)
				},
				_onMouseOut: function(a) {
					e.css(this.cursorNode, "display", "none"), e.css(this.timeNode, "display", "none")
				},
				_getSeconds: function(a) {
					...
					var d = a.touches ? a.touches[0].pageX : a.pageX,
						...
						g = this._liveshiftService.availableLiveShiftTime;
					return sec = g ? e / f * g : 0, sec < 0 && (sec = 0), sec > g && (sec = g), sec
				},
				_onMouseClick: function(a) {
					var b = this,
						c = this._getSeconds(a);
					this._player.trigger(j.Private.SeekStart, {
						fromTime: this._player.getCurrentTime()
					});
					var d = this._liveshiftService.getSourceUrl(c);
					this._player.loadByUrl(d, c, !0), this._player.trigger(j.Private.Play_Btn_Hide), this._liveshiftService.seekTime = c, b._player.trigger(j.Private.EndStart, {
						toTime: c
					})
				},
				_onMouseDown: function(a) {
					var b = this;
					a.preventDefault(), this._player.trigger(j.Private.SeekStart, {
						fromTime: this._player.getCurrentTime()
				...
				_onMouseUp: function(a) {
					...
					var b = this._liveshiftService.availableLiveShiftTime,
						c = this.playedNode.offsetWidth / this.el().offsetWidth * b,
						d = this._liveshiftService.getSourceUrl(c);
					this._player.loadByUrl(d, c, !0), this._player.trigger(j.Private.Play_Btn_Hide), this._liveshiftService.seekTime = c, this._player.trigger(j.Private.EndStart, {
						toTime: c
					})
				},
				_onMouseMove: function(a) {
					a.preventDefault();
					var b = this._getSeconds(a);
					this._updateProgressBar(this.playedNode, b), this._updateCursorPosition(b)
				},
				_onTimeupdate: function(a) {
					this._updateProgressBar(this.playedNode, this._player.getCurrentTime()), this._updateCursorPosition(this._player.getCurrentTime()), this._player.trigger(j.Private.UpdateProgressBar, {
				...
				_updateProgressBar: function(a, b) {
					if (1 != this._player._switchSourcing) {
						var c = 0;
						if (-1 == this._liveshiftService.seekTime) c = 1;
						else {
							var d = this._liveshiftService.availableLiveShiftTime;
							b += this._liveshiftService.seekTime, c = d ? b / d : 0, c > 1 && (this._liveshiftService.seekTime = -1)
						}
				...
				_updateCursorPosition: function(a) {
					if (1 != this._player._switchSourcing) {
						var b = 0;
						if (-1 == this._liveshiftService.seekTime) b = 1;
						else {
							var c = this._liveshiftService.availableLiveShiftTime;
							a += this._liveshiftService.seekTime, b = c ? a / c : 0, b > 1 && (this._liveshiftService.seekTime = -1)
						}
						var d = 18,
							f = 1 - d / this.el().clientWidth;
						this.cursorNode && (b > f ? (e.css(this.cursorNode, "right", "0px"), e.css(this.cursorNode, "left", "auto")) : (e.css(this.cursorNode, "right", "auto"), e.css(this.cursorNode, "left", 100 * b + "%")))
					}
				}
			});
		b.exports = k
	...
	9: [function(a, b, c) {
		var d = a("../ui/component"),
			...
			g = d.extend({
				...
				createEl: function() {
					var a = d.prototype.createEl.call(this, "div");
					return a.innerHTML = '<span class="current-time">00:00</span> <span class="time-bound">/</span> <span class="end-time">00:00</span><span class="live-text">Live: </span><span class="live-time"></span>', a
				},
				bindEvent: function() {
					var a = this;
					this._player.on(f.Video.TimeUpdate, function() {
						var b = a._liveshiftService,
							c = document.querySelector("#" + a.id() + " .current-time");
						if (b.liveShiftStartDisplay && b.availableLiveShiftTime > b.seekTime && -1 != b.seekTime) {
							var d = a._liveshiftService.getBaseTime(),
								f = e.formatTime(d + a._player.getCurrentTime());
							c.innerText = f
	...
	11: [function(a, b, c) {
		...
		f.players = {}, "function" == typeof define && define.amd ? define([], function() {
			return g
		}) : "object" == typeof c && "object" == typeof b && (b.exports = g)
	}, {
		"./lang/index": 16,
		"./lib/componentutil": 18,
		"./player/adaptivePlayer": 35
	}],
	12: [function(a, b, c) {
		var d = a("../lib/oo"),
			e = a("../lang/index"),
		...
		f.prototype.handle = function(a) {
			if (this._options.autoPlayDelay) {
				...
				b || (b = e.get("AutoPlayDelayDisplayText").replace("$$", this._options.autoPlayDelay)), this._player.trigger("info_show", b), this._player.trigger("h5_loading_hide"), this._player.trigger("play_btn_hide");
				var c = this;
	...
	16: [function(a, b, c) {
		var d = a("../config"),
			...
			g = "aliplayer_lang",
			h = function() {
				return void 0 !== window[g] && window[g] || (window[g] = (navigator.language || navigator.browserLanguage).toLowerCase()), window[g]
			}, i = function(b, c) {
				var d = window[g];
				...
				if (d) k(b, JSON.parse(d));
					...
					var f = "",
						g = m();
					f = a("flash" == b ? "en-us" == g ? "./flash/en-us" : "./flash/zh-cn" : "en-us" == g ? "./en-us" : "./zh-cn"), e.set(c, JSON.stringify(f)), k(b, f)
				}
			}, k = function(a, b) {
				var c = n(a);
				window[c] = b
				...
				var a = h();
				return "en-us" != a && "zh-cn" != a && (a = "en-us"), a
			}, n = function(a) {
				var b = m();
				return a || (a = "h5"), f + "_" + a + "_" + d.h5Version.replace(/\./g, "_") + "_" + b
			}, o = function(a, b) {
				b || (b = "h5");
				var c = n(b),
					d = window[c];
	...
	17: [function(a, b, c) {
		b.exports = b.exports = {
			...
			Error_Not_Support_encrypt_Text: "h5不支持加密视频的播放",
			...
			Error_MTS_Fetch_Urls_Text: "MST获取取数失败",
			...
			Open_Html_By_File: "不能直接在浏览器打开html文件，请部署到服务端",
			Maybe_Cors_Error: "请确认是否开启了允许跨域访问",
	...
	18: [function(a, b, c) {
		...
		b.exports.stopPropagation = function(a) {
			...
			}, a.Component = d.extend, a.EventType = e.Player
		}
	}, {
		"../player/base/event/eventtype": 38,
		"./oo": 28
	...
	19: [function(a, b, c) {
		...
		b.exports.LOAD_START = "loadstart", b.exports.LOADED_METADATA = "loadedmetadata", b.exports.LOADED_DATA = "loadeddata", b.exports.PROGRESS = "progress", b.exports.CAN_PLAY = "canplay", b.exports.CAN_PLYA_THROUGH = "canplaythrough", b.exports.PLAY = "play", b.exports.PAUSE = "pause", b.exports.ENDED = "ended", b.exports.PLAYING = "playing", b.exports.WAITING = "waiting", b.exports.ERROR = "error", b.exports.SUSPEND = "suspend", b.exports.STALLED = "stalled", b.exports.AuthKeyExpiredEvent = "authkeyexpired", b.exports.ErrorCode = {
			...
			OtherError: 4400,
			ServerAPIError: 4500
		}, b.exports.AuthKeyExpired = 7200, b.exports.AuthKeyRefreshExpired = 7e3, b.exports.AuthInfoExpired = 100, b.exports.VideoErrorCode = {
			1: 4015,
			2: 4016,
			3: 4013,
			4: 4400
			...
			Symbol: "symbol",
			Sprite: "Sprite"
		}, b.exports.SelectedStreamLevel = "selectedStreamLevel", b.exports.WidthMapToLevel = {
			0: "OD",
			640: "FD",
			960: "LD",
			1280: "SD",
	...
	22: [function(a, b, c) {
		...
		b.exports.el = function(a) {
			...
			return !(!a || !a.style) && (b && c ? (a.style[b] = c, !0) : c || "string" != typeof b ? !c && "object" == typeof b && (d.each(b, function(b, c) {
				a.style[b] = c
			}), !0) : a.style[b])
		}
	}, {
	...
	23: [function(a, b, c) {
		...
		b.exports.on = function(a, c, g) {
			...
			var d = f.hasData(a) ? f.getData(a) : {}, e = a.parentNode || a.ownerDocument;
			if ("string" == typeof c) {
				var g = null;
				(a.paramData || 0 == a.paramData) && (g = a.paramData, a.paramData = null, a.removeAttribute(g)), c = {
					type: c,
					target: a,
					paramData: g
				}
	...
	25: [function(a, b, c) {
		...
		b.exports.get = function(a, b, c, e, f) {
			...
			}), h = new XMLHttpRequest, i = d.parseUrl(a), j = window.location, k = i.protocol + i.host !== j.protocol + j.host, !k || !window.XDomainRequest || "withCredentials" in h ? (g = "file:" == i.protocol || "file:" == j.protocol, h.onreadystatechange = function() {
				4 === h.readyState && (200 === h.status || g && 0 === h.status ? b(h.responseText) : c(h.responseText))
			}) : (h = new window.XDomainRequest, h.onload = function() {
				b(h.responseText)
			}, h.onerror = c, h.onprogress = function() {}, h.ontimeout = c);
			try {
				void 0 === e && (e = !0), h.open("GET", a, e), f && (h.withCredentials = !0)
			} catch (a) {
				return void c(a)
			}
			try {
			...
			d.type = "text/javascript", d.src = a, d.onload = function() {
				b && b()
			}, c.appendChild(d)
		}
	}, {
	...
	26: [function(a, b, c) {
		...
		b.exports.render = function(a, b) {
			var c = b.align ? b.align : "tl",
				e = b.x ? b.x : 0,
				f = b.y ? b.y : 0;
			xunit = e.indexOf && e.indexOf("%") > 0 ? "" : "px", yunit = f.indexOf && f.indexOf("%") > 0 ? "" : "px", "tl" === c ? d.css(a, {
				float: "left",
				"margin-left": e + xunit,
				"margin-top": f + yunit
			}) : "tr" === c ? d.css(a, {
				float: "right",
				"margin-right": e + xunit,
				"margin-top": f + yunit
			}) : "tlabs" === c ? d.css(a, {
				position: "absolute",
				left: e + xunit,
	...
	27: [function(a, b, c) {
		...
		b.exports.create = Object.create || function(a) {
			...
			if (b.exports.isArray(a)) for (var f = 0, g = a.length; f < g && !1 !== c.call(e || this, a[f], f); ++f);
	...
	29: [function(a, b, c) {
		...
		b.exports.defaultH5Layout = [{
			...
			return !!(g.os.pc && g.browser.safari && a && g.browser.version.indexOf("11.") < 0)
			...
			return b.exports.adjustContainerLayout(c, a), c
			...
			if (a.useFlashPrism || b.exports.isFlv(a.source) || b.exports.isRTMP(a.source)) f = [{
				name: "liveDisplay",
				align: "tlabs",
				x: 15,
				y: 25
			...
			if (a.isLive) if (void 0 === a.skinLayout) e.skinLayout = [{
				name: "errorDisplay",
				align: "tlabs",
				x: 0,
				y: 0
				...
				for (var j = a.skinLayout.length, k = [], l = -1, m = 0; m < j; m++) if ("controlBar" == e.skinLayout[m].name) {
					l = m;
					for (var n = e.skinLayout[m].children.length, o = 0; o < n; o++) {
						var p = e.skinLayout[m].children[o].name;
						if ("liveDisplay" == p || "fullScreenButton" == p || "volume" == p || "snapshot" == p || g && ("progress" == p || "playButton" == p || "timeDisplay" == p)) {
							var q = e.skinLayout[m].children[o];
							"progress" == p ? q.name = "liveShiftProgress" : "timeDisplay" == p && (q.name = "liveShiftTimeDisplay"), k.push(q)
						}
					}
					break
				} - 1 != l && (e.skinLayout[l].children = k)
			}
			return (void 0 === a.components || !a.components || d.isArray(a.components) && 0 == a.components.length) && (e.components = [h]), e
		}
	}, {
		"../config": 10,
		"../player/base/plugin/defaultemptycomponent": 58,
		"./dom": 22,
		"./object": 27,
		"./ua": 31
	}],
	...
	31: [function(a, b, c) {
		function d() {
			...
			return f && (c = "macOS"), "X11" == navigator.platform && !e && !f && (c = "Unix"), String(navigator.platform).indexOf("Linux") > -1 && (c = "Linux"), e ? "windows" : c
		}
		function e() {
			var a = navigator.userAgent,
				b = "";
			return (a.indexOf("Windows NT 5.0") > -1 || a.indexOf("Windows 2000") > -1) && (b = "2000"), (a.indexOf("Windows NT 5.1") > -1 || a.indexOf("Windows XP") > -1) && (b = "XP"), (a.indexOf("Windows NT 5.2") > -1 || a.indexOf("Windows 2003") > -1) && (b = "2003"), (a.indexOf("Windows NT 6.0") > -1 || a.indexOf("Windows Vista") > -1) && (b = "Vista"), (a.indexOf("Windows NT 6.1") > -1 || a.indexOf("Windows 7") > -1) && (b = "7"), (a.indexOf("Windows NT 6.2") > -1 || a.indexOf("Windows 8") > -1) && (b = "8"), (a.indexOf("Windows NT 6.3") > -1 || a.indexOf("Windows 8.1") > -1) && (b = "8.1"), (a.indexOf("Windows NT 10") > -1 || a.indexOf("Windows 10") > -1) && (b = "10"), b
		}
		function f() {
		...
		b.exports.IS_MAC_SAFARI = b.exports.IS_MAC && b.exports.IS_SAFARI && !b.exports.IS_CHROME && !b.exports.HAS_FLASH, b.exports.IS_IOS = b.exports.IS_IPHONE || b.exports.IS_IPAD || b.exports.IS_IPOD || b.exports.IS_MAC_SAFARI, b.exports.IOS_VERSION = function() {
			...
			var b = d,
				e = d.split("/");
			return e && e.length > 0 && (b = e[0]), e = b.split(":"), e && e.length > 0 && (b = e[0]), b
		...
		function(a) {
			function b(a, b) {
				var c = this.os = {}, g = this.browser = {}, h = a.match(/Web[kK]it[\/]{0,1}([\d.]+)/),
		...
		b.exports.formatTime = function(a) {
			...
			if (a) {
				var b = parseInt(a.getHours()),
					...
					d = parseInt(a.getSeconds());
				return b = b >= 10 ? b : "0" + b, c = c >= 10 ? c : "0" + c, d = d >= 10 ? d : "0" + d, ("00" === b ? "" : b + ":") + c + ":" + d
			}
			return ""
		}, b.exports.convertToTimestamp = function(a, b) {
			var c = "";
			return a && (b ? c = a.gettime() : (c = Date.parse(a), c /= 1e3)), c
		}, b.exports.convertToDate = function(a, b) {
			var c = "";
			if (a) {
				c = new Date;
				b || 1e3, c.setTime(1e3 * a)
			}
			return c
			...
			var b, c, d, e, f;
			return a = decodeURIComponent(a), c = a.split("?"), 2 !== c.length ? {} : (f = c[1], (b = f.split("&")) ? (d = {}, e = 0, $(b).each(function() {
				var a;
				if (a = b[e].split("="), 2 !== a.length) return void e++;
				d[a[0]] = a[1].replace(/\+/g, " "), e++
			}), d) : {})
		}
	}, {
		"./dom": 22,
	...
	34: [function(a, b, c) {
		var d, e, f = a("../lib/oo"),
			...
			o = {
				...
				init: function(a, b, c) {
					void 0 === c && (c = !0), this.trackLog = c, this.player = a, this.requestId = "", this.sessionId = i.guid(), this.playId = 0, this.firstPlay = !0, this.osName = k.os.name, this.osVersion = k.os.version || "", this.exName = k.browser.name, this.exVersion = k.browser.version || "";
					...
					try {
						...
						(function(a) {
							...
							A = D._userNetInfo.cdnIp = a.content.ldns, B = D._userNetInfo.localIp = a.content.localIp, D._log("FETCHEDIP", {
								cdn_ip: A,
								local_ip: B
							})
						})
				...
				_onPlayerFinish: function() {
					this._log("STOP", {
						vt: Math.floor(1e3 * this.player.getCurrentTime())
					}), this.sessionId = i.guid(), this.playId = 0
				},
				_onPlayerPlay: function() {
					if (0 == this.playId && (this.playId = i.guid()), this.firstPlay || 0 != this.pause_flag || this.seeking || (this.sessionId = i.guid()), this.firstPlay = !1, !this.buffer_flag && this.player._options.autoplay) return this.first_play_time = (new Date).getTime(), this._log("PLAY", {
						dsm: "fix",
						vt: 0,
				...
				_log: function(a, b) {
					if (this.trackLog) {
						...
						var e = l.logReportTo;
						c.e = o[a], c.ri = this.sessionId, c.t = (new Date).getTime(), c.cdn_ip = this._userNetInfo.cdnIp, c.hn = this._userNetInfo.localIp;
						...
						m && m.vid && (k = m.vid), h.push("vid=" + k), h = h.join("&"), "" == h && (h = "0"), c.args = encodeURIComponent(h);
						var n = [];
						return g.each(c, function(a, b) {
							n.push(a + "=" + b)
				...
				_getUuid: function() {
					var a = h.get("p_h5_u");
					return a || (a = i.guid(), h.set("p_h5_u", a, 730)), a
				}
			});
		b.exports = p
	}, {
	...
	35: [function(a, b, c) {
		...
		b.exports.create = function(a, b) {
			"function" != typeof b && (b = function() {}), a.readyCallback = b, n.setCurrentLanguage(a.language);
		...
		"../lib/playerutil": 29,
		"../lib/ua": 31,
		"./audio/audioplayer": 36,
		"./base/player": 57,
		"./flash/flashplayer": 63,
		"./flv/flvplayer": 65,
		"./hls/hlsplayer": 67,
		"./saas/mtsplayer": 70,
		"./saas/vodplayer": 76,
		"./taotv/taotvplayer": 79
	}],
	36: [function(a, b, c) {
		var d = a("../base/player"),
			e = a("../../ui/component"),
			...
			h = d.extend({
				init: function(a, b) {
					this._isAudio = !0, void 0 === b.skinLayout && (b.skinLayout = playerUtil.defaultAudioLayout), d.call(this, a, b)
				}
			});
	...
	37: [function(a, b, c) {
		...
		"../../../lib/event": 23,
		"../eventHandler/player/index": 42,
		"../eventHandler/video/index": 51,
		"./eventtype": 38
	}],
	38: [function(a, b, c) {
		var d = {
			...
			LiveShiftQueryComplete: "liveShiftQueryCompleted",
	...
	40: [function(a, b, c) {
		...
		b.exports.handle = function(a) {
			var b = this;
			b.play(), b._seeking = !1, b.trigger(d.Player.CompleteSeek, a.paramData.toTime)
		}
	}, {
		"../../event/eventtype": 38
	}],
	41: [function(a, b, c) {
		var d = a("../../event/eventtype");
		a("../../../../lib/constants"), a("../../../../lang/index");
		b.exports.handle = function(a) {
			var b = this,
				c = a.paramData;
			b.trigger(d.Private.H5_Loading_Hide), b.trigger(d.Private.Cover_Hide), b.trigger(d.Private.Play_Btn_Hide), c = c || {}, b._monitor && (c.uuid = b._monitor._getUuid(), c.requestId = b._serverRequestId, c.cdnIp = b._monitor._userNetInfo.cdnIp, c.localIp = b._monitor._userNetInfo.localIp), b._isError = !0, b.trigger(d.Private.Error_Show, c), b.trigger(d.Private.LifeCycleChanged, {
				type: d.Player.Error,
				data: c
			})
		}
	...
	42: [function(a, b, c) {
		var d = a("../../event/eventtype"),
			...
			i = function(a, b, c) {
				...
				e.on(d, b, function(d) {
					var e;
					e = c && c.handle ? c.handle : f.handle, e.call(a, d, b)
				})
			};
	...
	46: [function(a, b, c) {
		...
		b.exports.handle = function(a) {
			var b = this;
			b._retrySwitchUrlCount = 0, b._liveRetryCount = 0, b._clearLiveErrorHandle();
	...
	48: [function(a, b, c) {
		b.exports.handle = function(a, b) {
			var c = this,
				d = "";
			a && a.paramData && (d = a.paramData), c.trigger(b, d)
		}
	}, {}],
	49: [function(a, b, c) {
		var d = a("../../event/eventtype"),
		...
		b.exports.handle = function(a) {
			var b = this;
			b.waiting = !1, b._options.rePlay ? (b.seek(0), b.tag.play()) : b._options.isLive && (b.trigger(d.Private.H5_Loading_Hide), b.trigger(d.Private.Info_Show, e.get("Live_End"))), b.trigger(d.Player.Ended)
		}
	}, {
		"../../../../lang/index": 16,
		"../../event/eventtype": 38
			...
			if (b.waiting = !1, b._checkTimeoutHandle && clearTimeout(b._checkTimeoutHandle), b.checkOnline()) {
				...
				if (a.srcElement.error.code && (c = a.srcElement.error.code, i = g.VideoErrorCode[a.srcElement.error.code], j = c + " || " + j), b._options.isLive) b._options.liveRetry > b._liveRetryCount ? b._reloadAndPlayForM3u8() : (b._liveRetryCount = 0, b.trigger(d.Player.LiveStreamStop), b._liveErrorHandle = setTimeout(function() {
					var a = {
						mediaId: "ISLIVE",
						error_code: i,
						error_msg: h.get("Error_Play_Text") + "，" + h.get("Error_Retry_Text")
					};
	...
	51: [function(a, b, c) {
		var d = a("../../../../lib/event"),
			...
			f = {
				...
				var f = a.tag;
				d.on(f, b, function(d) {
					c.handle.call(a, d, b), b != e.Video.Error && a.trigger(e.Private.LifeCycleChanged, {
						type: b,
						data: d
					})
				})
		...
		b.exports.bind = function(a) {
			...
			for (var c in e.Video) {
				var d = e.Video[c];
				b = void 0 !== f[d] ? f[d] : f.common, g(a, d, b)
			}
		}
	}, {
		"../../../../lib/event": 23,
	...
	52: [function(a, b, c) {
		...
		b.exports.handle = function(a) {
			var b = this;
			b._checkTimeoutHandle && clearTimeout(b._checkTimeoutHandle), b.trigger(d.Private.AutoStreamHide), b.trigger(d.Player.Pause), b.waiting = !1
		}
	}, {
		"../../event/eventtype": 38
	}],
	53: [function(a, b, c) {
		...
		b.exports.handle = function(a) {
			var b = this;
			b.trigger(d.Private.Error_Hide), b.trigger(d.Private.Cover_Hide), b.trigger(d.Private.AutoStreamHide), b.waiting = !1, b.trigger(d.Player.Play)
		}
	}, {
		"../../event/eventtype": 38
	}],
	54: [function(a, b, c) {
		...
		b.exports.handle = function(a) {
			var b = this;
			b.trigger(d.Private.H5_Loading_Hide), b.trigger(d.Private.Cover_Hide), b.trigger(d.Private.Info_Hide), b.waiting = !1, b._checkTimeoutHandle && clearTimeout(b._checkTimeoutHandle), b.trigger(d.Private.AutoStreamHide), b.trigger(d.Player.Playing), b.trigger(d.Private.Play_Btn_Hide)
		}
	}, {
		"../../event/eventtype": 38
	}],
	...
	56: [function(a, b, c) {
		...
		b.exports.handle = function(a) {
			var b = this;
			b.trigger(d.Private.H5_Loading_Show), b.waiting = !0, b._checkTimeoutHandle && clearTimeout(b._checkTimeoutHandle), b._checkTimeoutHandle = setTimeout(function() {
	...
	57: [function(a, b, c) {
			...
			z = d.extend({
				init: function(a, b) {
					if (this.tag = a, this.loaded = !1, this.played = !1, this.waiting = !1, this._urls = [], this._currentPlayIndex = 0, this._retrySwitchUrlCount = 0, this._isError = !1, this._isHls = !1, this._liveRetryCount = 0, this._seeking = !1, this._serverRequestId = 0, this._created = !1, void 0 === b.skinLayout && (b.skinLayout = m.defaultH5Layout), d.call(this, this, b), this.addClass("prism-player"), b.plugins && e.each(b.plugins, function(a, b) {
						this[a](b)
					}, this), this.fullscreenService = new x(this), m.isLiveShift(b) && (this._liveshiftService = new y(this)), this.UI = {}, b.useNativeControls ? this.tag.setAttribute("controls", "controls") : this.UI = h, this.initChildren(), l.openInFile()) {
						var c = {
							mediaId: j._options.vid,
							error_code: "",
							error_msg: p.get("Open_Html_By_File")
						};
						return void j.trigger(v.Private.Error_Show, c)
					}
					if (r.onAll(this), this._lifeCycleManager = new w(this), this._monitor = new i(this, {
						video_id: 0,
						album_id: 0,
						...
						if (this._liveshiftService && !this._liveshiftService.validate()) {
							var f = {
								...
								error_code: k.ErrorCode.InvalidParameter,
								error_msg: p.get("ShiftLiveTime_Error")
							};
							return void this.trigger(v.Player.Error, f)
						}
						...
						}), this._overrideNativePlay(), this._options.readyCallback(this)
					}
				}
			});
		z.prototype.initPlay = function(a) {
			...
			var a = this.options(),
				b = a.skinLayout;
			if (!1 !== b && !e.isArray(b)) throw new Error("PrismPlayer Error: skinLayout should be false or type of array!");
			!1 !== b && 0 !== b.length && (this.options({
				children: b
			}), d.prototype.initChildren.call(this)), a.preload || a.autoplay || (this.UI.cover = s, this.addChild("cover", a)), this.UI.playanimation = t, this.addChild("playanimation", a), this.UI.autoStreamSelector = u, this.addChild("autoStreamSelector", a), this.trigger(v.Private.UiH5Ready)
		}, z.prototype.createEl = function() {
			var a = !1;
			"VIDEO" !== this.tag.tagName ? (this._el = this.tag, this.tag = d.prototype.createEl.call(this, "video"), this._options.playsinline && (this.tag.setAttribute("webkit-playsinline", ""), this.tag.setAttribute("playsinline", ""), this.tag.setAttribute("x-webkit-airplay", ""))) : (a = !0, this._el = this.tag.parentNode);
			var b = this._el,
				c = this.tag;
			this._options.enableSystemMenu || (c.addEventListener ? c.addEventListener("contextmenu", function(a) {
				a.preventDefault()
			}, !1) : c.attachEvent("oncontextmenu", function() {
				window.event.returnValue = !1
			})), c.player = this;
			var g = f.getElementAttributes(c);
			return e.each(g, function(a) {
			...
			if (0 == navigator.onLine) {
				...
				return this.logError(a), a.display_msg = p.get("Error_Offline_Text"), this.trigger(v.Player.Error, a), !1
			}
			return !0
			...
			if (0 != this._urls.length) {
				...
				o.set(k.SelectedStreamLevel, a.definition, 365), this.trigger(v.Private.QualityChange, p.get("Quality_Change_Fail_Switch_Text"));
				this.getCurrentTime();
				this._options.source = a.Url, this.tag.setAttribute("src", this._options.source), this.tag.play()
			}
			...
			b = window.setInterval(function(d) {
				...
				if (c.readyState > 0) {
					...
					a.tag.duration = e, a.trigger(v.Private.ReadyState), clearInterval(b)
				}
			}, 100)
			...
			var a = this;
			return (this._options.preload || this.loaded) && this.tag.src || this._initLoad(this._options.source), a.trigger(v.Private.Cover_Hide), this.tag.play(), this
			...
			var b = this.tag.playbackRate;
			try {
				var c = this;
				this.tag.currentTime = a, setTimeout(function() {
			...
			this._clearLiveErrorHandle(), this._options.vid = 0, this._options.source = a, this._monitor && this._monitor.updateVideoInfo({
				video_id: 0,
				album_id: 0,
				source: a,
				from: this._options.from
			}), this.initPlay(), (this._options.preload || this._options.autoplay) && this.trigger(v.Private.Cover_Hide), this._options.autoplay ? this.trigger(v.Player.Play) : this.trigger(v.Player.Pause), b || (b = 0), !b && 0 != b || isNaN(b) || this.seek(b)
		}, z.prototype.loadByUrl = function(a, b, c) {
			this._clearLiveErrorHandle(), this.trigger(v.Private.Error_Hide), this._options.vid = 0, this._options.source = a, this._monitor && this._monitor.updateVideoInfo({
				video_id: 0,
				album_id: 0,
				source: a,
				from: this._options.from
			}), this._options._autoplay = c, this.initPlay(c), (this._options.preload || this._options.autoplay) && this.trigger(v.Private.Cover_Hide), this._options.autoplay || c ? this.trigger(v.Player.Play) : this.trigger(v.Player.Pause);
			var d = this;
			g.one(this.tag, v.Video.CanPlay, function(a) {
			...
			var a = p.get("Volume_Mute");
			return this._player.trigger(v.Private.Info_Show, {
				text: a,
				duration: 1e3,
				align: "lb"
			}), this
			...
			var b = p.get("Curent_Volume") + "<span>" + a + "</span>";
			this._player.trigger(v.Private.Info_Show, {
				text: b,
				duration: 1e3,
				align: "lb"
			})
			...
			if (!m.validateSource(b)) {
				...
				return this.logError(c), c.display_msg = p.get("Error_Invalidate_Source"), void this.trigger(v.Player.Error, c)
			}
			this.trigger(v.Private.H5_Loading_Hide), void 0 === a && (a = !1), this._created || (this._created = !0, this.trigger(v.Private.Created)), this.loaded || this.trigger(v.Player.Init), (this._options.autoplay || this._options.preload || a) && (this._initLoad(b), this._options.autoplay || this._options._autoplay ? this.tag.play() : this.trigger(v.Private.Play_Btn_Show))
		}, z.prototype._initLoad = function(a) {
			this._options.autoplay && this.trigger(v.Private.H5_Loading_Show), this.getMetaData(), a && this.tag.setAttribute("src", a), this.readyTime = (new Date).getTime(), this.loaded = !0
			...
			l.sleep(1e3 * b), this._liveRetryCount++, this.tag.load(this._options.source), this.tag.play()
			...
			if (a.indexOf("m3u8") > 0 ? "" != this.tag.canPlayType("application/x-mpegURL") || m.isSupportHls() || (b = p.get("Error_Not_Support_M3U8_Text")) : a.indexOf("mp4") > 0 && "" == this.tag.canPlayType("video/mp4") && (b = p.get("Error_Not_Support_MP4_Text")), b) {
				...
				this.logError(c), c.display_msg = b, this.trigger(v.Player.Error, c)
			}
			return b
			...
			var c = 0,
				d = 0;
			if (this._monitor) return this._options && (c = this._options.vid || "0", d = this._options.from || "0"), this._monitor.updateVideoInfo({
				video_id: c,
				album_id: 0,
				source: this._options.source,
				from: d
		...
		"../../monitor/monitor": 34,
		"../../ui/component": 80,
		"../../ui/component/cover": 83,
		"../../ui/component/error-display": 84,
		"../../ui/component/info-display": 87,
		"../../ui/component/play-animation": 89,
		"../../ui/exports": 97,
		"../service/fullscreenservice": 77,
		"../service/liveshiftservice": 78,
		"./event/eventmanager": 37,
		"./event/eventtype": 38,
		"./plugin/lifecyclemanager": 60,
		"./x5play": 62
	}],
	58: [function(a, b, c) {
		var d = a("../../../lib/oo"),
	...
	60: [function(a, b, c) {
		var d = a("../../../lib/object"),
			...
			g = a("./status"),
			h = function(a) {
				this._player = a, a._status = "init", this.components = [];
				...
				if (b && d.isArray(b) && b.length > 0) for (var c = 0; c < b.length; c++) {
					...
					createEl = l[f.createEl], createEl && "function" == typeof createEl && createEl.call(l, a.el()), this.components.push({
						name: k,
						obj: l
					})
				}
				var m = this;
				a.on(e.Private.LifeCycleChanged, function(b) {
		...
		var i = function(a) {
			...
			if (b) {
				var c = b.paramData,
					d = c.type,
					g = c.data;
				i(d) && (d = f.loading), k(a, d);
				for (var h = this.components.length, j = 0; j < h; j++) {
	...
	62: [function(a, b, c) {
		var d = a("../../lib/ua"),
			...
			f = function(a, b) {
				...
				b ? (height = e, width = f) : (height = c.indexOf("%") ? c : c + "px", width = d.indexOf("%") ? d : d + "px"), a.tag.style.width = f, a.tag.style.height = e, a.el().style.height = b ? e : height
			}, g = function(a, b) {
				if (a.originalLayout) {
					var c = a.originalLayout;
					a.el().style.height = c.container.height, a.el().style.width = c.container.width, a.tag.style.width = c.video.width, a.tag.style.height = c.video.height
				}
			};
		b.exports.isAndroidX5 = function() {
			...
			if (d.os.android && d.is_X5) {
				...
				"center" != a._options.x5_video_position && e.addClass(a.tag, "x5-top-left"), void 0 !== a._options.x5_orientation && a.tag.setAttribute("x5-video-orientation", a._options.x5_orientation)
			}
		}
	}, {
		"../../lib/dom": 22,
	...
	63: [function(a, b, c) {
		var d = a("../../ui/component"),
			...
			k = a("../../lib/playerutil"),
			l = a("../../lib/util"),
			m = a("../../ui/component/info-display"),
			n = a("../../ui/component/error-display"),
			o = a("../../feature/autoPlayDelay"),
			p = a("../../commonui/autostreamselector"),
			q = a("../base/event/eventtype"),
			r = a("../saas/ststoken"),
			s = d.extend({
				init: function(a, b) {
					if (void 0 === b.skinLayout && (b.skinLayout = k.defaultFlashLayout), d.call(this, this, b), this._id = "prism-player-" + e.guid(), this.tag = a, this._el = this.tag, this._childrenUI = [m, n], this.initChildren(), this.id = this._id, window[this.id] = this, j.setCurrentLanguage(this._options.language, "flash"),
					l.openInFile()) {
						var c = {
							mediaId: this._options.vid,
							error_code: "",
							error_msg: j.get("Open_Html_By_File", "flash")
						};
						return void this.trigger(q.Private.Error_Show, c)
					}
					if (this._options.vid && this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret) {
						var f = this;
						r.getPlayAuth(this._options, function(a) {
							f._options.playauth = a, f._createPlayer()
						}, function(a) {
							var b = {
								mediaId: f._options.vid,
								error_code: a.Code,
								error_msg: a.Message
							};
							a.sri && (b.sri = a.sri), b.display_msg = a.display_msg, console.dir(b), f.trigger(q.Private.Error_Show, b)
						}, "flash")
				...
				_createPlayer: function() {
					if (this._options.autoPlayDelay) {
						var a = new o(this),
							b = this;
						a.handle(function() {
							b._options.autoplay = !0, b._initPlayer(), b._childrenUI.push(p), b.initChildren()
						})
					} else this._initPlayer(), this._childrenUI.push(p), this.initChildren()
				},
				_initPlayer: function() {
					var a = "100%",
						b = "100%",
						c = "//" + i.domain + "/de/prismplayer-flash/" + i.flashVersion + "/PrismPlayer.swf",
				...
				_comboFlashVars: function() {
					...
					var e = this._options,
						g = {
							...
							statisticService: e.statisticService ? e.statisticService : i.logReportTo,
					...
					return e.cover && (g.cover = e.cover), e.extraInfo && (g.extraInfo = encodeURIComponent(JSON.stringify(e.extraInfo))), g.logInfo && (g.logInfo = encodeURIComponent(JSON.stringify(g.logInfo))), g.languageData = encodeURIComponent(JSON.stringify(j.getLanguageData("flash"))), g.language = j.getCurrentLanguage(), h.each(g, function(a, b) {
						k.push(a + "=" + b)
					}), k.join("&")
				},
				initChildren: function() {
					for (var a = this._childrenUI.length, b = 0; b < a; b++) {
						var c = new this._childrenUI[b](this, this._options),
							d = c.el();
						d.id = c.id(), this.contentEl().appendChild(d), c.bindEvent()
					}
					var e = document.querySelector("#" + this._options.id + " .prism-info-display");
					g.css(e, "display", "none")
				},
				flashReady: function() {
					this.flashPlayer = this._getPlayer(this.id), this._isReady = !0;
					var a, b = this._options.skinRes,
						c = this._options.skinLayout;
					if (!1 !== c && !h.isArray(c)) throw new Error("PrismPlayer Error: skinLayout should be false or type of array!");
				...
				onPlay: function() {
					this._status = "play", this.trigger("play"), this._clearTimeoutHandle(), this.trigger(q.Private.AutoStreamHide)
				},
				onEnded: function() {
					this._clearTimeoutHandle(), this._status = "ended", this.trigger("ended")
				},
				onPause: function() {
					this._status = "pause", this._clearTimeoutHandle(), this.trigger(q.Private.AutoStreamHide), this.trigger("pause")
				},
				...
				onVideoBuffer: function() {
					if ("pause" != this._status) {
						...
						this._checkTimeoutHandle = setTimeout(function() {
							a.trigger(q.Private.AutoStreamShow)
				...
				_getVideoUrls: function() {
					...
					if (a && a.Urls) for (var c = 0; c < a.Urls.length; c++) {
						var d = a.Urls[c].value,
							e = d.desc.indexOf("_"),
							f = j.get(d.definition, "flash");
						d.desc = e > 0 ? f + "_" + d.height : f, b.push(d)
					}
					return {
						Urls: b,
						index: a.index
						...
						var a = this,
							b = function() {
								a._checkVideoStatusHandler = setTimeout(function() {
									...
									"playing" == c.videoStatus && "bufferFull" == c.bufferStatus ? (a._status = "playing", a._clearTimeoutHandle()) : "videoPlayOver" == c.videoStatus && (a._status = "ended", a._clearTimeoutHandle()), b()
								}, 500)
							};
						b()
					}
			...
			if (h || l(a, n)) {
				b.prototype._checkFlvReady = function() {
					...
					if (this._checkFlvReady(), this._options.isLive && this.tag.load(), this.trigger(k.Private.Cover_Hide), 0 == this._seeking) {
						var a = 0;
						this.tag.ended || (a = this.getCurrentTime()), this.seek(a)
					}
					return this.tag.paused && this._flv.play(), this
					...
					this._checkFlvReady(), a === that.tag.duration && a--;
					try {
					...
					function b(a, b) {
						...
						c ? (d.enableStashBuffer = a._options.enableStashBufferForFlv, stashInitialSize = a._options.stashInitialSizeForFlv, d.autoCleanupSourceBuffer = !0) : d.lazyLoadMaxDuration = 600, a._originalUrl = a._options.source, a._flv = flvjs.createPlayer({
							type: "flv",
							isLive: c,
							url: a._options.source
						}, d), o(a, a._flv), a._flv.attachMediaElement(a.tag), a._flv.load(), a._flv.play(), a._initPlayBehavior(b), e && e(a._flv)
					}
					if (i.browser.safari && this.trigger(k.Private.Snapshot_Hide), g.contentProtocolMixed(n)) {
						...
						return c.display_msg = j.get("Request_Block_Text"), void this.trigger(k.Player.Error, c)
					}
					that = this, this._isLoadedHls ? buildHls(this, a) : (this.trigger(k.Private.H5_Loading_Show), m.call(that, function() {
				...
				var o = function(a, b) {
					var c = !1;
					b.on(flvjs.Events.ERROR, function(b, d, e) {
						var h = f.ErrorCode.OtherError,
							i = j.get("Error_Play_Text");
						if (d == flvjs.ErrorDetails.NETWORK_EXCEPTION) {
							var l = a.getOptions().source;
							!l || 0 != l.toLowerCase().indexOf("http://") && 0 != l.toLowerCase().indexOf("https://") ? (h = f.ErrorCode.InvalidSourceURL, i = j.get("Error_Invalidate_Source"), c = !0) : (h = f.ErrorCode.NetworkError, i = j.get("Error_Network_Text"))
						...
						var m = function() {
							if (setTimeout(function() {
								...
								a.logError(b), b.display_msg = i, a.trigger(k.Player.Error, b)
							}
						};
						if (a._options.isLive && !c) {
							...
							if (n.liveRetry > a._liveRetryCount) {
								...
								g.sleep(1e3 * o), a.loadByUrl(n.source), a._liveRetryCount++
			...
			if (h || k(a, m, n)) {
				b.prototype._checkHlsReady = function() {
					...
					if (this._checkHlsReady(), this.trigger(j.Private.Cover_Hide), this.tag.ended) this.replay();
						...
						this._hls.startLoad(a), this.tag.paused && this.tag.play()
					}
					return this
				}, b.prototype.replay = function() {
					...
					if (g.contentProtocolMixed(m)) {
						...
						return c.display_msg = i.get("Request_Block_Text"), void this.trigger(j.Player.Error, c)
					}
					...
					b.on(Hls.Events.ERROR, function(b, c) {
						if (c.details != Hls.ErrorDetails.FRAG_LOOP_LOADING_ERROR && 1 != a._seeking && (0 != c.fatal || c.type == Hls.ErrorTypes.NETWORK_ERROR)) {
							var d = f.ErrorCode.LoadedMetadata,
								...
								h = !1;
							if (c.details == Hls.ErrorDetails.MANIFEST_LOAD_ERROR) {
								h = !0;
								c.networkDetails;
								"404" == c.response.code ? (d = f.ErrorCode.NotFoundSourceURL, e = i.get("Error_Not_Found")) : "403" == c.response.code ? (d = f.ErrorCode.AuthKeyExpired, e = i.get("Error_AuthKey_Text")) : e = "0" == c.response.code ? e + "，" + i.get("Maybe_Cors_Error") : i.get("Error_Load_M3U8_Failed_Text")
							} else c.details == Hls.ErrorDetails.MANIFEST_LOAD_TIMEOUT ? (h = !0, e = i.get("Error_Load_M3U8_Timeout_Text")) : c.details == Hls.ErrorDetails.MANIFEST_PARSING_ERROR || c.details == Hls.ErrorDetails.MANIFEST_INCOMPATIBLE_CODECS_ERROR ? (h = !0, e = i.get("Error_M3U8_Decode_Text")) : c.type == Hls.ErrorTypes.NETWORK_ERROR ? (d = f.ErrorCode.NetworkError, e = i.get("Error_Network_Text")) : c.type != Hls.ErrorTypes.MUX_ERROR && c.type != Hls.ErrorTypes.MEDIA_ERROR || (d = f.ErrorCode.PlayDataDecode, e = i.get("Error_TX_Decode_Text"));
							e = e + "(" + c.details + ")";
							var k = function() {
								if (a.pause(), setTimeout(function() {
									...
									a.logError(b), b.display_msg = e, a.trigger(j.Player.Error, b)
								}
							};
							if (a._options.isLive) {
								...
								if (l.liveRetry > a._liveRetryCount) {
									...
									g.sleep(1e3 * m), h && a.loadByUrl(l.source), a._liveRetryCount++
	...
	69: [function(a, b, c) {
		...
		function e(a, b) {
			...
			return j(d, b), j(c, b), d.length > 0 ? d : c
		}
		var f = a("../../lib/io"),
			g = a("../../lib/constants"),
			h = a("./signature"),
			...
			j = function(a, b) {
				...
				for (var d = a.length, e = 0; e < d; e++) {
					var f = a[e],
						...
						i = "";
					i = void 0 === h ? "未知" : c == h ? h + f.height : h, f.desc = i, c = h
				}
			};
	...
	71: [function(a, b, c) {
		function d(a) {
			...
			if (!b) return j.set(f.SelectedStreamLevel, a[0].definition, 365), 0;
		...
		var e = a("../base/player"),
			...
			n = e.extend({
				init: function(a, b) {
					this._authKeyExpiredHandle = new g(this), e.call(this, a, b)
				}
			});
		n.prototype.loadData = function(a) {
			...
			var c = this;
			this._urls = [], this._currentPlayIndex = 0, this._retrySwitchUrlCount = 0, this._authKeyExpiredHandle.clearTick(), this.service.getDataByAuthInfo(a, this._options.qualitySort, function(a) {
				...
				c._urls = a.urls, c._currentPlayIndex = d(c._urls);
				var g = a.urls[c._currentPlayIndex],
					j = g.Url;
				c._options.source = j, l.isHls(j) ? h.inject(c, n, e.prototype, c._options) : l.isFlv(j) && i.inject(c, n, e.prototype, c._options), c.log("COMPLETEFETCHDATA", {
					cost: (new Date).getTime() - b
				}), c._authKeyExpiredHandle.tick(f.AuthKeyRefreshExpired), c.trigger(m.Private.SourceLoaded, g), c.initPlay()
			}, function(a) {
			...
			var e = b.Code ? b.Code : "OTHER_ERR_CODE",
				...
				h = (f.ErrorCode.ServerAPIError, b.display_msg || "");
			g.indexOf("InvalidParameter.Rand") > -1 || g.indexOf('"Rand" is not valid.') > -1 ? (f.ErrorCode.EncrptyVideoNotSupport, h = k.get("Error_Not_Support_encrypt_Text")) : g.indexOf("SecurityToken.Expired") > -1 ? (f.ErrorCode.AuthKeyExpired, h = k.get("Error_Playauth_Expired_Text")) : g.indexOf("InvalidVideo.NoneStream") > -1 && (f.ErrorCode.URLsIsEmpty, h = k.get("Error_Fetch_NotStream") + "(format=" + d._options.format + ")");
			...
			b.sri && (j.sri = b.sri), d.logError(j), j.display_msg = h || k.get("Error_Vod_Fetch_Urls_Text"), d.trigger("error", j), console.log("PrismPlayer Error: " + c + "! error_msg :" + g + ";")
		}, b.exports = n
	}, {
		"../../lang/index": 16,
		"../../lib/constants": 19,
	...
	72: [function(a, b, c) {
		...
		b.exports.randomUUID = function() {
			...
			var d = [];
			for (var e in a) d.push(e);
			for (var f = d.sort(), g = "", h = f.length, e = 0; e < h; e++) "" == g ? g = f[e] + b + a[f[e]] : g += c + f[e] + b + a[f[e]];
			return g
		}, b.exports.makeUTF8sort = function(a, c, d) {
			if (!a) throw new Error("PrismPlayer Error: vid should not be null!");
			var e = [];
			for (var f in a) e.push(f);
			for (var g = e.sort(), h = "", i = g.length, f = 0; f < i; f++) {
				var j = b.exports.AliyunEncodeURI(g[f]),
					k = b.exports.AliyunEncodeURI(a[g[f]]);
				"" == h ? h = j + c + k : h += d + j + c + k
			}
			return h
		...
		var d = a("../../lib/io"),
			...
			i = function(a, b, c, i) {
				var j = (f.randomUUID(), f.randomUUID()),
					...
					n = "https://vod.cn-shanghai.aliyuncs.com/?" + m;
				d.get(n, function(a) {
					if (a) {
						var d = JSON.parse(a);
						b && b(d.PlayAuth)
					...
					if (c) {
						var b = JSON.parse(a);
						c({
							Code: e.ErrorCode.ServerAPIError,
							Message: b.Code + "|" + b.Message,
							sri: b.requestId,
							display_msg: h.get("Fetch_Playauth_Error", i)
						})
					}
				})
			};
	...
	75: [function(a, b, c) {
		function d(a, b, c, d) {
			var k = h.randomUUID(),
				...
				p = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
			f.get(p, function(a) {
				if (a) {
					var f = JSON.parse(a),
						g = f.PlayInfoList.PlayInfo;
		...
		function e(a, b) {
			...
			for (var d = a.length - 1; d >= 0; d--) {
				var e = {};
				e.width = a[d].Width, e.height = a[d].Height, e.definition = a[d].Definition, e.Url = a[d].PlayURL, e.desc = g.QualityLevels[e.definition], c.push(e)
			}
			return c
		}
		var f = a("../../lib/io"),
	...
	76: [function(a, b, c) {
		var d = a("./saasplayer"),
			...
			i = d.extend({
				init: function(a, b) {
					d.call(this, a, b), this.service = f;
					var c = this;
					this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret ? h.getPlayAuth(this._options, function(a) {
		...
		i.prototype.loadByVod = function() {
			...
			var f = this;
			this.service.loadData(d, this._options.qualitySort, function(a) {
	...
	77: [function(a, b, c) {
		var d = a("../../lib/ua"),
			...
			j = function() {
				...
				a.cancelFn = "webkitExitFullscreen", a.eventName = "webkitfullscreenchange", a.isFullScreen = "webkitDisplayingFullscreen";
				else {
					for (var c = 5, f = 0; f < c; f++) if (b[f][1] in document) {
						a.requestFn = b[f][0], a.cancelFn = b[f][1], a.eventName = b[f][4], a.isFullScreen = b[f][6];
						break
					}
			...
			k = function(a) {
				this.isFullWindow = !1, this.isFullScreen = !1, this.isFullScreenChanged = !1, this._requestFullScreenTimer = null, this._cancelFullScreenTimer = null, this._player = a;
				var b = this,
					c = j;
				c && f.on(document, c.eventName, function(a) {
		...
		k.prototype.requestFullScreen = function() {
			...
			var a = j,
				b = this._player.el(),
				c = this;
			if (d.IS_IOS) return b = this._player.tag, b[a.requestFn](), this;
	...
	78: [function(a, b, c) {
		var d = a("../../lib/io"),
			...
			h = function(a, b) {
				if (a && a) {
					var c = new Date(a),
						d = new Date(b),
						f = d.valueOf() / 1e3 - c.valueOf() / 1e3;
					return {
						start: c,
						end: d,
						endDisplay: e.extractTime(d),
						totalTime: f
					}
				}
			}, i = function(a, b) {
				...
				this._player = a, this._originalPlayUrl = a._options.source, this._liveShiftUrl = a._options.liveTimeShiftUrl, this.liveTimeRange = h(a._options.liveStartTime, a._options.liveOverTime), this.availableLiveShiftTime = 0, this.seekTime = -1;
				var b = this;
				a.liveShiftSerivce = {
					setLiveTimeRange: function(a, c) {
						b.setLiveTimeRange(a, c)
					},
					queryLiveShift: function(a, c, d) {
		...
		}, j.prototype.getBaseTime = function() {
			this.liveShiftStartDisplay;
			return -1 == this.seekTime ? e.parseTime(this.currentTimeDisplay) : e.parseTime(this.liveShiftStartDisplay) + this.seekTime
		}, j.prototype.getSourceUrl = function(a) {
			var b = this._originalPlayUrl;
			return this.availableLiveShiftTime <= a ? b : (a = this.timestampStart + parseInt(a), b = -1 == b.indexOf("?") ? b + "?lhs_start_unix_s_0=" + a : b + "&lhs_start_unix_s_0=" + a)
		}, j.prototype.getTimeline = function(a, b) {
			if (this._liveShiftUrl) {
				var c = this;
				this.queryLiveShift(this._liveShiftUrl, function(d) {
					if (d) {
						var e = d;
						0 == e.retCode ? (i(c, e.content.current), c._player.trigger(g.Private.LiveShiftQueryCompleted), a && a()) : b({
							Code: f.ErrorCode.ServerAPIError,
					...
					if (b && a) {
						...
						b({
							Code: f.ErrorCode.ServerAPIError,
							Message: c.retCode + "|" + c.description + "|" + c.content
						})
					}
				})
			}
		...
		}, j.prototype.tickLocalLiveTime = function() {
			var a = this,
				b = function() {
					a._localLiveTimeHandler = setTimeout(function() {
						a.currentTimestamp++, i(a, a.currentTimestamp), a._player.trigger(g.Private.LiveShiftQueryCompleted), b()
					}, 1e3)
				};
			b()
		}, j.prototype.setLiveTimeRange = function(a, b) {
			a || (a = this._player._options.liveStartTime), b || (b = this._player._options.liveOverTime), this.liveTimeRange = h(a, b), i(this, this.currentTimestamp), this._player.trigger(g.Private.LiveShiftQueryCompleted)
		}, j.prototype.queryLiveShift = function(a, b, c) {
			d.get(a, function(a) {
				if (a) {
					var d = JSON.parse(a);
					0 == d.retCode ? b && b(d) : c && c(d)
				} else c && c(a)
			}, function(a) {
				c && c(a)
			})
		}, j.prototype.stop = function(a) {
	...
	79: [function(a, b, c) {
		...
		g.prototype.loadVideoInfo = function(a) {
			...
			f.jsonp("//tv.taobao.com/player/json/getBaseVideoInfo.do?vid=" + b + "&playerType=3", function(f) {
				if (1 !== f.status || !f.data.source) throw new Error("PrismPlayer Error: #vid:" + b + " cannot find video resource!");
				var g, h = -1;
				_.each(f.data.source, function(a, b) {
					var c = +a.substring(1);
					c > h && (h = c)
	...
	80: [function(a, b, c) {
		var d = a("../lib/oo"),
			...
			l = d.extend({
				init: function(a, b) {
					var c = this;
					this._player = a, this._eventState = "", this._options = f.copy(b), this._el = this.createEl();
					var d = a.id;
					"function" == typeof a.id && (d = a.id()), this._id = d + "_component_" + e.guid(), this._children = [], this._childIndex = {}, this._player.on(k.Private.UiH5Ready, function() {
		...
		l.prototype.renderUI = function() {
			...
			if (a && this._children) {
				for (var b = !1, c = this._children.length - 1; c >= 0; c--) if (this._children[c] === a) {
			...
			var a, b, c, d, e;
			if (a = this, b = this.options().children) if (f.isArray(b)) for (var g = 0; g < b.length; g++) c = b[g], "string" == typeof c ? (d = c, e = {}) : (d = c.name, e = c), a.addChild(d, e);
	...
	81: [function(a, b, c) {
		var d = a("../component"),
			...
			h = d.extend({
				...
				bindEvent: function() {
					var a = this;
					this._player.on(f.Player.Play, function() {
						a.addClass("playing"), a.removeClass("pause"), a._hide()
					}), this._player.on(f.Player.Pause, function() {
						a.removeClass("playing"), a.addClass("pause");
						var b = a._player._status;
						b != g.ended && b != g.error && a._show()
		...
		var d = a("../component"),
			...
			f = d.extend({
				...
				onEvent: function() {
					...
					1 == b.controlBarForOver && (d = "hover"), "hover" == d ? (c.hide(), a.on(e.Private.MouseOver, function() {
						c._show()
		...
		var d = a("../component"),
			...
			g = d.extend({
				...
				createEl: function() {
					...
					return b && (a.style.backgroundImage = "url(" + b + ")"), a
				},
				_hide: function(a) {
					var b = this,
				...
				bindEvent: function() {
					var a = this;
					a._player.on(f.Private.Cover_Show, a._show), a._player.on(f.Private.Cover_Hide, a._hide)
				}
			});
		b.exports = g
	}, {
	...
	84: [function(a, b, c) {
		var d = a("../component"),
			...
			k = d.extend({
				...
				bindEvent: function() {
					var a = this;
					a._player.on(j.Private.Error_Show, function(b) {
						var c = null;
						a._player.getMonitorInfo && (c = a._player.getMonitorInfo()), a._show(b, c)
				...
				_show: function(a, b) {
					...
					if (b) {
						...
						var j = "http://player.alicdn.com/detection.html?from=h5&vid=" + d + "&source=" + g + "&pd=" + b.pd + "&vt=" + b.vt + "&tt=" + b.tt + "&uuid=" + b.uuid + "&av=" + b.av + "&bi=" + b.bi + "&md=" + b.md + "&vu=" + g + "&lang=" + i.getCurrentLanguage();
						h.href = j
					} else f.css(h, "display", "none");
					var k = c.display_msg || c.error_msg;
					document.querySelector("#" + this.id() + " .prism-error-content p").innerText = k, document.querySelector("#" + this.id() + " .errorCode .info-content").innerText = c.error_code;
					var l = document.querySelector("#" + this.id() + " .vid");
					if (c.mediaId ? (f.css(l, "display", "block"), document.querySelector("#" + this.id() + " .vid .info-content").innerText = c.mediaId) : f.css(l, "display", "none"), c.uuid) document.querySelector("#" + this.id() + " .uuid .info-content").innerText = c.uuid;
					else {
						var m = document.querySelector("#" + this.id() + " .uuid");
						f.css(m, "display", "none")
					}
					if (c.requestId) document.querySelector("#" + this.id() + " .requestId .info-content").innerText = c.requestId;
					else {
						var n = document.querySelector("#" + this.id() + " .requestId");
					...
					var o = document.querySelector(".prism-ErrorMessage");
					f.css(o, "display", "block"), this._player.trigger("play_btn_hide")
				},
				_hide: function() {
	...
	85: [function(a, b, c) {
		var d = a("../component"),
			...
			f = d.extend({
				...
				bindEvent: function() {
					var a = this;
					this._player.on(e.Player.RequestFullScreen, function() {
	...
	86: [function(a, b, c) {
		...
		var d = a("../component"),
			...
			f = d.extend({
				...
				bindEvent: function() {
					var a = this;
					a._player.on(e.Private.H5_Loading_Show, a._loading_show), a._player.on(e.Private.H5_Loading_Hide, a._loading_hide)
				}
			});
		b.exports = f
	}, {
	...
	87: [function(a, b, c) {
		var d = a("../component"),
			...
			g = d.extend({
				...
				bindEvent: function() {
					var a = this;
					a._player.on(f.Private.Info_Show, function(b) {
						var c = document.querySelector("#" + a.getId()),
							d = b.paramData;
						d && (void 0 !== d.text && d.text ? (c.innerHTML = d.text, void 0 !== d.duration && d.duration && setTimeout(function() {
	...
	89: [function(a, b, c) {
		var d = a("../component"),
			...
			g = d.extend({
				...
				bindEvent: function() {
					var a = this;
					this._player.on(e.Player.Play, function() {
						...
						var b = a._player._status;
						b != f.ended && b != f.error && (a.removeClass("prism-play-animation"), a.addClass("prism-pause-animation"), a.removeClass("play-apply-animation"), setTimeout(function() {
							a.addClass("play-apply-animation")
						}))
					})
				}
	...
	91: [function(a, b, c) {
		var d = a("../component"),
			...
			l = d.extend({
				...
				createEl: function() {
					var a = d.prototype.createEl.call(this);
					return a.innerHTML = '<div class="prism-progress-loaded"></div><div class="prism-progress-played"></div><div class="prism-progress-cursor"></div><p class="prism-progress-time"></p>', a
				},
				bindEvent: function() {
					var a = this;
					this.loadedNode = document.querySelector("#" + this.id() + " .prism-progress-loaded"), this.playedNode = document.querySelector("#" + this.id() + " .prism-progress-played"), this.cursorNode = document.querySelector("#" + this.id() + " .prism-progress-cursor"), this.timeNode = document.querySelector("#" + this.id() + " .prism-progress-time"), this.controlNode = document.getElementsByClassName("prism-controlbar")[0];
					var b = document.querySelector("#" + this.id());
					f.on(this.cursorNode, "mousedown", function(b) {
						a._onMouseDown(b)
					}), f.on(this.cursorNode, "touchstart", function(b) {
						a._onMouseDown(b)
				...
				_progressMove: function(a) {
					var b = this._getSeconds(a);
					this.timeNode.innerText = j.formatTime(b);
					var c = this._player.getDuration() ? b / this._player.getDuration() : 0,
						d = this.timeNode.clientWidth,
						f = 1 - d / this.el().clientWidth;
					c > f && (c = f), this.cursorNode && e.css(this.timeNode, "left", 100 * c + "%")
				},
				_hideProgress: function(a) {
					f.off(this.cursorNode, "mousedown"), f.off(this.cursorNode, "touchstart")
				},
				...
				_getSeconds: function(a) {
					...
					return g < 0 && (g = 0), g > this._player.getDuration() && (g = this._player.getDuration()), g
				},
				_onMouseClick: function(a) {
					var b = this._getSeconds(a);
					if (!this._canSeekable(b)) return void this._player.trigger(k.Private.Info_Show, {
						text: i.get("Can_Not_Seekable"),
						duration: 2e3
					});
					this._player.trigger(k.Private.SeekStart, {
						fromTime: this._player.getCurrentTime()
					}), this._player.seek(b), this._player.trigger(k.Private.EndStart, {
						toTime: b
					})
				},
				_onMouseDown: function(a) {
					var b = this;
					a.preventDefault(), this._player.trigger(k.Private.SeekStart, {
						fromTime: this._player.getCurrentTime()
					}), f.on(this.controlNode, "mousemove", function(a) {
						b._onMouseMove(a)
					}), f.on(this.controlNode, "touchmove", function(a) {
				...
				_onPlayerMouseUp: function(a) {
					...
					var b = this.playedNode.offsetWidth / this.el().offsetWidth * this._player.getDuration();
					this._player.getDuration();
					isNaN(b) || this._player.seek(b), this._player.trigger(k.Private.EndStart, {
						toTime: b
					})
				},
				_onMouseMove: function(a) {
					a.preventDefault();
					var b = this._getSeconds(a);
					this._player._hls || (this._player.seek(b), this._player.play()), this._updateProgressBar(this.playedNode, b), this._updateCursorPosition(b)
				},
				_onTimeupdate: function(a) {
					this._updateProgressBar(this.playedNode, this._player.getCurrentTime()), this._updateCursorPosition(this._player.getCurrentTime()), this._player.trigger(k.Private.UpdateProgressBar, {
						time: this._player.getCurrentTime()
					})
				},
				_onProgress: function(a) {
				...
				_updateProgressBar: function(a, b) {
					if (1 != this._player._switchSourcing) {
						var c = this._player.getDuration() ? b / this._player.getDuration() + .005 : 0;
						a && e.css(a, "width", 100 * c + "%")
					}
				},
				_updateCursorPosition: function(a) {
					if (1 != this._player._switchSourcing) {
						...
						this.cursorNode && (b > d ? (e.css(this.cursorNode, "right", "0px"), e.css(this.cursorNode, "left", "auto")) : (e.css(this.cursorNode, "right", "auto"), e.css(this.cursorNode, "left", 100 * b + "%")))
					}
				}
			});
		b.exports = l
	...
	92: [function(a, b, c) {
		var d = a("../component"),
			...
			h = d.extend({
				...
				bindEvent: function() {
					var a = this;
					this._player.on(g.Private.Snapshot_Hide, function() {
						e.css(a._el, "display", "none")
					}), this.on("click", function() {
						a.trigger(g.Player.Snapshoting);
						var b = document.createElement("canvas"),
							c = a._player.tag,
							d = c.videoWidth,
							e = c.videoHeight,
							h = a._player._getSanpshotMatric();
						b.width = h.width || d, b.height = h.height || e;
						var j = a._player.getCurrentTime(),
							k = b.getContext("2d");
						k.drawImage(c, 0, 0, d, e), i(k, a._player.getOptions());
						var l = "",
							m = "";
						try {
							var l = b.toDataURL("image/jpeg", h.rate || 1)
						} catch (a) {
							m = a
						}
						var n = "",
							o = "",
							p = "";
						l && (n = l, o = n.substr(n.indexOf(",") + 1), p = f.toBinary(o)), a.trigger(g.Player.Snapshoted, {
							time: j,
							base64: n,
							binary: p,
							error: m
	...
	93: [function(a, b, c) {
		var d = a("../component"),
			...
			l = d.extend({
				...
				createEl: function() {
					var a = d.prototype.createEl.call(this, "div");
					return a.innerHTML = '<div class="current-speed-selector" key="1">' + j.get("Speed_Text") + '</div><ul class="speed-selector-list"></ul>', a
				},
				bindEvent: function() {
					var a = this,
					...
					h.on(c, "mouseleave", function() {
						...
						if (a._hasGeneratedList) g.css(c, "display", 0 == a._isShown ? "block" : "none"), a._isShown = !a._isShown, a._isShown && a._player.trigger(k.Private.StreamSelectorHide);
						else {
							var d = i.SpeedLevels;
							e.each(d, function(d, e) {
								...
								h.innerText = d.text, f.appendChild(h), c.appendChild(f)
						...
						var d = b.srcElement ? b.srcElement : b.target,
							...
							h = d.text;
						if (void 0 !== h) {
							a._previousSelection && g.removeClass(a._previousSelection, "current"), a._previousSelection = d, g.addClass(d, "current"), a._player.setSpeed(e), f.delayHide(c);
							var i = j.get("Speed_Switch_To") + "<span>" + h + "</span>";
							a._player.trigger(k.Private.Info_Show, {
								text: i,
								duration: 1e3,
								align: "lb"
							})
	...
	94: [function(a, b, c) {
		var d = a("../component"),
			...
			m = d.extend({
				...
				createEl: function() {
					var a = d.prototype.createEl.call(this, "div");
					return a.innerHTML = '<div class="current-stream-selector">' + k.get("Quality_SD_Text") + '</div><ul class="stream-selector-list"></ul>', a
				},
				showTip: function(a, b) {
					this._player.trigger(l.Private.Info_Show, {
						text: a,
						duration: b,
						align: "lb"
					})
				...
				bindEvent: function() {
					...
					i.on(c, "mouseleave", function() {
						...
						if (c.length > a._player._currentPlayIndex) {
							...
							d = k.get("Quality_The_Url"), a._previousSelection && (h.removeClass(a._previousSelection, "current"), d = a._previousSelection.text), h.addClass(f, "current"), e = f.text;
							document.querySelector("#" + a.id() + " .current-stream-selector").innerText = e, a._previousSelection = f
						} else if (a._player._currentPlayIndex > 0) {
							var g = a._player._urls,
								i = a._player._currentPlayIndex;
							d = g[i - 1].desc, e = g[i].desc
						}
						...
						d.innerText = c, h.css(d, "display", "block")
					}), i.on(b, "click", function() {
						if (a._hasGeneratedList) h.css(c, "display", 0 == a._isShown ? "block" : "none"), a._isShown = !a._isShown, a._isShown && a._player.trigger(l.Private.SpeedSelectorHide);
						else {
							var b = a._player._urls;
							b.length > 1 && e.each(b, function(b, d) {
								...
								f.innerText = b.desc, e.appendChild(f), c.appendChild(e), a._hasGeneratedList = !0, h.css(c, "display", "block"), a._player.trigger(l.Private.SpeedSelectorHide)
							})
						}
						...
						var d = b.srcElement ? b.srcElement : b.target,
							...
							l = d.text;
						if (void 0 !== l) {
							a._player._switchSourcing = !0, a._previousSelection && h.removeClass(a._previousSelection, "current"), a._previousSelection = d, h.addClass(d, "current"), a._player._currentPlayIndex = i, g.set(j.SelectedStreamLevel, a._player._urls[i].definition, 365), a._player._urls.length > i && (e = a._player._urls[i].Url);
							document.querySelector("#" + a.id() + " .current-stream-selector").innerText = l, a._player.loadByUrl(e, a._player.getCurrentTime(), !a._player.paused()), h.css(c, "display", "none"), a._isShown = !1, a.showTip(k.get("Quality_Change_Text") + "<span>" + l + "</span>", 2e3), setTimeout(function() {
	...
	95: [function(a, b, c) {
		var d = a("../component"),
			...
			g = d.extend({
				...
				bindEvent: function() {
					var a = this;
					this._player.on(f.Video.DurationChange, function() {
	...
	96: [function(a, b, c) {
		var d = a("../component"),
			...
			h = d.extend({
				...
				createEl: function() {
					var a = d.prototype.createEl.call(this, "div");
					return a.innerHTML = '<div class="volume-icon"></div> <div class="volume-control"><div class="volume-range"><div class="volume-value"></div><div class="volume-cursor"></div></div><div class="volume-control-icon"></div></div>', a
				},
				bindEvent: function() {
					var a = this;
					this.icon = document.querySelector("#" + a.id() + "  .volume-icon"), this.controlicon = document.querySelector("#" + a.id() + "  .volume-control-icon"), this.control = document.querySelector("#" + a.id() + "  .volume-control"), this.volumnValue = document.querySelector("#" + a.id() + "  .volume-value"), this.volumnRange = document.querySelector("#" + a.id() + "  .volume-range"), this.volumnCursor = document.querySelector("#" + a.id() + "  .volume-cursor"), f.on(this.icon, "click", function() {
						if (a._shown) e.css(a.control, "display", "none"), a._shown = !1;
						else {
							var b = a._player.getVolume();
							a._setVolumnUI(b), e.css(a.control, "display", "block"), a._shown = !0
						}
					}), f.on(this.volumnRange, "click", function(b) {
						var c = a._getPosition(b).toFixed(2);
						c < 0 && (c = 0), c > 1 && (c = 1), a._setVolumnUI(c), a._setMuteUI(c), a._player.setVolume(c)
						...
						var c = b.paramData;
						c > -1 && a._setVolumnUI(c), a._setMuteUI(c)
				...
				_getBottom: function() {
					if (window.getComputedStyle) {
						var a = window.getComputedStyle(this.volumnRange, null).getPropertyValue("bottom");
						return parseFloat(a)
					}
					return 26
				},
				_onMouseDown: function(a) {
					var b = this;
					a.preventDefault(), f.on(this.control, "mousemove", function(a) {
						b._onMouseMove(a)
				...
				_onMouseUp: function(a) {
					var b = this;
					a.preventDefault(), b._offEvent();
					var c = (this.volumnValue.offsetHeight / this.volumnRange.offsetHeight).toFixed(2);
					this._player.setVolume(c), this._setMuteUI(c)
				},
				_onMouseMove: function(a) {
					a.preventDefault();
					var b = this._getPosition(a);
					b < 0 && (b = 0), b > 1 && (b = 1), this._setVolumnUI(b)
				},
				_getPosition: function(a) {
					for (var b = this.el(), c = 0; b = b.offsetParent;) c += b.offsetTop;
	...
	97: [function(a, b, c) {
		b.exports = {
			...
			liveShiftProgress: a("../commonui/liveshiftprogress"),
			liveShiftTimeDisplay: a("../commonui/livetimedisplay")
		}
	}, {
		"../commonui/liveshiftprogress": 8,
		"../commonui/livetimedisplay": 9,
		"./component/big-play-button": 81,
		"./component/controlbar": 82,
		"./component/error-display": 84,
		"./component/fullscreen-button": 85,
		"./component/h5-loading": 86,
		"./component/info-display": 87,
		"./component/live-display": 88,
		"./component/play-button": 90,
		"./component/progress": 91,
		"./component/snapshot": 92,
		"./component/speed-selector": 93,
		"./component/stream-selector": 94,
		"./component/time-display": 95,
		"./component/volume": 96
	}]
}, {}, [11]);